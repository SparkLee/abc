...
function play(text: string): void {
  ...
  const audio = new Audio('https://nls-gateway.aliyuncs.com/stream/v1/tts?appkey=hzu1IYKCtKAgo7ko&token=545f91461920497287311f3a02b5be6f&text=' + text + '&format=wav&voice=ruilin')
  audio.play()
}
</script>
